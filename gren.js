...
var $author$project$Main$update$ = function(_v0, _v1) {
	return { command: $gren_lang$core$Platform$Cmd$none, model: {  } };
};
...
var $gren_lang$browser$Html$Attributes$height = function(n) {
	return A2($gren_lang$browser$Html$Attributes$attribute, 'height', $gren_lang$core$String$fromInt(n));
};
var $gren_lang$browser$Html$img = $gren_lang$browser$Html$node('img');
var $gren_lang$browser$Html$main_ = $gren_lang$browser$Html$node('main');
var $gren_lang$browser$Html$Attributes$src = function(url) {
	return $gren_lang$browser$Html$Attributes$stringProperty$('src', url);
};
var $gren_lang$browser$Html$Attributes$width = function(n) {
	return A2($gren_lang$browser$Html$Attributes$attribute, 'width', $gren_lang$core$String$fromInt(n));
};
var $author$project$Main$view = function(_v0) {
	return A2($gren_lang$browser$Html$main_, [  ], [ A2($gren_lang$browser$Html$div, [ $gren_lang$browser$Html$Attributes$class('game container') ], [ A2($gren_lang$browser$Html$img, [ $gren_lang$browser$Html$Attributes$src('img/blue-square.svg'), $gren_lang$browser$Html$Attributes$width(32), $gren_lang$browser$Html$Attributes$height(32) ], [  ]), A2($gren_lang$browser$Html$img, [ $gren_lang$browser$Html$Attributes$src('img/green-triangle.svg'), $gren_lang$browser$Html$Attributes$width(32), $gren_lang$browser$Html$Attributes$height(32) ], [  ]), A2($gren_lang$browser$Html$img, [ $gren_lang$browser$Html$Attributes$src('img/pink-diamond.svg'), $gren_lang$browser$Html$Attributes$width(32), $gren_lang$browser$Html$Attributes$height(32) ], [  ]), A2($gren_lang$browser$Html$img, [ $gren_lang$browser$Html$Attributes$src('img/purple-parallelogram.svg'), $gren_lang$browser$Html$Attributes$width(32), $gren_lang$browser$Html$Attributes$height(32) ], [  ]), A2($gren_lang$browser$Html$img, [ $gren_lang$browser$Html$Attributes$src('img/white-circle.svg'), $gren_lang$browser$Html$Attributes$width(32), $gren_lang$browser$Html$Attributes$height(32) ], [  ]), A2($gren_lang$browser$Html$img, [ $gren_lang$browser$Html$Attributes$src('img/yellow-star.svg'), $gren_lang$browser$Html$Attributes$width(32), $gren_lang$browser$Html$Attributes$height(32) ], [  ]), A2($gren_lang$browser$Html$img, [ $gren_lang$browser$Html$Attributes$src('img/wild-orb.svg'), $gren_lang$browser$Html$Attributes$width(32), $gren_lang$browser$Html$Attributes$height(32) ], [  ]) ]) ]);
};
var $author$project$Main$main = $gren_lang$browser$Browser$element({ init: $author$project$Main$init, subscriptions: $author$project$Main$subscriptions, update: $author$project$Main$update, view: $author$project$Main$view });
